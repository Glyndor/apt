...
# The landing page is its own script so it can be tested without gpg or
# reprepro; see scripts/build-index-page.sh and tests/build-index-page.test.sh.
"$(dirname "$0")/build-index-page.sh" "$OUT_DIR"
